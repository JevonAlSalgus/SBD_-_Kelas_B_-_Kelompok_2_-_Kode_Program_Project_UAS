...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>your minimarket name</span>
            <input type="text" placeholder="enter your minimarket name" name="name" required>
         </div>
         <div class="inputBox">
            <span>your minimarket number</span>
            <input type="number" placeholder="enter your minimarket number" name="number" required>
         </div>
         <div class="inputBox">
